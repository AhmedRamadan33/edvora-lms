...
use App\Http\Requests\Instructor\StartChatRequest;
...
class ChatController extends Controller
{
    public function index(Request $request, ChatService $chats): View
    {
        ...
        return view('instructor.chat.index', [
            'conversations' => $conversations,
            'students' => $chats->eligibleStudentsFor($user),
    ...
    {
        $conversation = $chats->startAsInstructor($request->user(), $request->integer('student_id'));
