...
<div class="ed-page-head">
    <div>
        ...
        <p>{{ __('Send an email and in-app notification to students.') }}</p>
    </div>
</div>

<div class="row g-4">
    <div class="col-lg-5">
        @include('partials.announcement-form', ['actionUrl' => route('admin.announcements.store'), 'students' => $students])
    </div>
    <div class="col-lg-7">
