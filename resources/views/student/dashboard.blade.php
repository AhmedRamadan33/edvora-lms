...
<div class="col-md-6 col-xl-4">
    <div class="ed-panel h-100 p-3">
        <div class="small text-muted mb-1">{{ $enrollment->course->instructor?->name }}</div>
        ...
        <a href="{{ route('learn.course', $enrollment->course) }}" class="btn btn-primary btn-sm">{{ __('Continue') }}</a>
    </div>
</div>
@empty
<div class="col-12">
